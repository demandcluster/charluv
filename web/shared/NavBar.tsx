...
const NavBar: Component = () => {
  ...
  const Title = (
    <A href="/">
      <div class="flex w-full justify-center">
        <span class="m-2 p-2" style="background:#55b89cff;">
          <img width="200px" alt="Charluv" src={logoDark} />
        </span>
      </div>
    </A>
  )
  ...
  return (
    <Show when={!isChat()}>
      <div
        data-header=""
        class={`bg-[var(--menu-bg)] sm:none flex h-[48px] justify-between gap-4 border-b-2 border-[var(--bg-800)] px-4 py-3 max-sm:p-1 sm:hidden`}
      >
        <div class="flex w-full max-w-5xl items-center justify-between gap-2 font-semibold sm:justify-start">
          ...
          <div class="ellipsis flex w-full flex-col">
            <Show when={isChat()} fallback={Title}>
              <span class="w-full text-center text-[0.6rem]">Charluv</span>
