...
export const setComponentPageTitle = (newTitle: string) => {
  createEffect(() => {
    document.title = `${newTitle} - Charluv`

    onCleanup(() => {
      document.title = 'Charluv'
    })
  })
...
export const adapterSettings: {
  ...
  repetitionPenaltyRange: ['horde', 'novel', 'kobold', 'ooba', 'charluv', 'tabby', 'ollama'],
  repetitionPenaltySlope: ['horde', 'novel', 'kobold'],
  tailFreeSampling: ['horde', 'novel', 'kobold', 'ooba', 'charluv', 'aphrodite', 'tabby'],
  minP: [
    'llamacpp',
    'kobold',
    'koboldcpp',
  ...
  topA: ['horde', 'novel', 'kobold', 'ooba', 'charluv', 'aphrodite', 'tabby', 'openrouter'],
  topK: [
    'horde',
    'novel',
    'kobold',
  ...
  mirostatLR: ['novel', 'ooba', 'charluv', 'llamacpp', 'aphrodite', 'tabby', 'ollama'],
  mirostatTau: ['novel', 'ooba', 'charluv', 'llamacpp', 'aphrodite', 'tabby', 'ollama'],
