...
> = (props) => {
  ...
  const subMax = createMemo(() => {
    const level = user.user?.admin ? Infinity : user.user?.premium ? 10 : user.userLevel
  ...
  return (
    <div class="flex flex-col gap-2" classList={{ hidden: props.tab !== 'General' }}>
      <Select
        ...
        items={FORMATS}
        value={props.inherit?.modelFormat || 'Charluv'}
      ...
      <Card class="flex flex-col gap-2">
        ...
        <RangeInput
          ...
          min={16}
          max={props.inherit?.maxTokens || 300}
          step={1}
        ...
        <RangeInput
          ...
          min={16}
          max={props.inherit?.maxContextLength || defaultPresets.basic.maxContextLength}
          step={1}
