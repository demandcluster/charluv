  ...
  return (
    ...
    >
      <div class="drawer__content flex flex-col gap-2 px-4">
        <div class="ph-1 hidden w-full px-4 pt-2 sm:flex" style="background:#55b89cff;">
          <A href="/">
            <img width="300px" src={user.ui?.mode === 'light' ? logoDark : logo} />
          </A>
        </div>
      ...
      <div class="flex h-16 w-full flex-col items-center justify-between border-t-2 border-[var(--bg-700)] px-4">
        <div class="mt-2 flex w-full items-center justify-between">
          <div class="flex items-center gap-4">
            ...
            />
            <div class={user.user?.premium ? 'font-bold text-yellow-500' : 'font-bold'}>
              {user.profile?.handle}
            </div>
