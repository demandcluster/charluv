...
const Terms: Component = () => {
  return (
    <div class="container">
      ...
      <Divider />
      <section class="flex flex-shrink flex-col  gap-4">
        <h3 class="text-2xl">Rights Charluv Grants You.</h3>
        <div>
          Charluv grants you a personal, limited, non-exclusive, revocable, non-transferable, and
      ...
      <Divider />
      <section class="flex flex-shrink flex-col  gap-4">
        <h3 class="text-2xl">Rights you Grant Charluv.</h3>
        <div>
          By using the Service, you grant Charluv a non-exclusive, worldwide, royalty-free,
      ...
      <section class="flex flex-shrink flex-col  gap-4">
        ...
        <div>
          ...
          taxes. Charluv reserves the right to modify its fees and pricing at any time. You are
      ...
      <section class="flex flex-shrink flex-col  gap-4">
        ...
        <div>
          Charluv's designated copyright agent for notice of claims of copyright infringement can be
        ...
        <div>
          Email: <a href="mailto:legal@Charluv.chat">legal@Charluv.chat</a>
        </div>
      </section>
      <Divider />
      <section class="flex flex-shrink flex-col  gap-4">
        ...
        <div>
          ...
          AVAILABLE", AND "WITH ALL FAULTS". Charluv DISCLAIMS ALL WARRANTIES OF ANY KIND, WHETHER
      ...
      <section class="flex flex-shrink flex-col  gap-4">
        ...
        <div>
          b. Notwithstanding the foregoing, Charluv may seek injunctive or other equitable relief to
      ...
      <section class="flex flex-shrink flex-col  gap-4">
        ...
        <div>
          a. You agree to indemnify, defend, and hold harmless Charluv, its affiliates, officers,
      ...
      <section class="flex flex-shrink flex-col  gap-4">
        ...
        <div>
          ...
          into with Charluv in connection with the Service, shall constitute the entire agreement
          between you and Charluv concerning the Service.
        </div>
        <div>
