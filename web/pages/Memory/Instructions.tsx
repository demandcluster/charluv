...
Memory books are a way to dynamically provide context to your characters as you talk with them. 
...
const Instructions: Component = () => {
  setComponentPageTitle('Memory help')
  return (
    <>
      <PageHeader title="Memory Help" />
