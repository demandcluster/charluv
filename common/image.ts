export const IMAGE_SUMMARY_PROMPT = {
  ...
  horde: `(Summarise the scene at this moment in time. Include descriptions of scene, each character, their appearance, age, weight, and their state of dress. Infer the characters state of dress from the conversation)`,
}
